...
def flow_cubepadding_to_equirect(flow):
    print("===========True in input" in np.isnan(flow))
    _SIZE_ = 256
    ...
    print("===========True in output" in np.isnan(result))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--enable_cubepadding', type=bool, default=True, help="enable cubepadding")
    parser.add_argument('--enable_fusion_E_C', type=bool, default=False, help="enable fusion_E_C")
    parser.add_argument('--enable_fusion_C_P', type=bool, default=True, help="enable fusion_C_P")
    parser.add_argument('--enable_fusion_E_P', type=bool, default=True, help="enable fusion_E_P")
