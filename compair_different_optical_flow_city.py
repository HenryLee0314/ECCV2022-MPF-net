...
# equirect_weight_map = np.swapaxes(np.swapaxes(equirect_weight_map, 0, 1), 1, 2)
# equirect_weight_map = 255 * equirect_weight_map
# cv2.imshow('image', equirect_weight_map.astype(np.uint8)) 
# cv2.waitKey()
...
for index in range(139):
    ...
    flow_file_gt = "/media/yiheng/T2/__DATASET__/City_100_r/flow/original_file_Optical_Flow_Frame_" + "%05d"%(index) +'.flo'
